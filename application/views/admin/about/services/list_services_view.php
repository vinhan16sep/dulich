        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <a href="<?php echo base_url('admin/about/creatServices') ?>" class="btn btn-primary" role="button">Add Item</a>
                            ...
                            <table id="table" class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/about/editServices') ?>" id="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
