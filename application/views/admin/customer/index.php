        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo base_url('admin/customer/create') ?>" class="btn btn-primary" role="button">Thêm mới</a>
                        </div>
                        <div class="col-md-6">
                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        <td><?php echo $i++ ?></td>
                                        <td>
                                            <img src="<?php echo base_url('assets/upload/customer/'.$value['image']) ?>" alt="anh-mo-ta" width=150px>
                                        </td>
                                        <td><?php echo $value['title'] ?></td>
                                        <td>
                                            <?php echo ($value['is_active'] == 1)? '<span class="label label-success">Đang sử dụng</span>' : '<span class="label label-warning">Không sử dụng</span>' ?>   
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url('admin/customer/detail/'.$value['id']) ?>"
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url('admin/customer/edit/'. $value['id']) ?>" class="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
                                            &nbsp&nbsp&nbsp
                                            ...
                                            <!-- <a href="<?php echo base_url('admin/customer/remove/'.$value['id']); ?>" class="dataActionDelete"><i class="fa fa-remove" aria-hidden="true"></i> </a> -->
                                        </td>
